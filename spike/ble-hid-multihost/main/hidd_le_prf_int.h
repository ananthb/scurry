...
/* scurry: was 1. One dongle must hold a bonded HID link to every target
   at once, so switching machines is choosing a conn_id rather than paying
   a 200ms-2s BLE reconnect on every screen-edge crossing. Must stay <=
